...
public class OXExporterFromA3 extends ZUGFeRDExporterFromA3 {
	...
	public OXExporterFromA3 load(String pdfFilename) throws IOException {
		RandomAccessRead rpdf = new RandomAccessReadBufferedFile(pdfFilename);
		ensurePDFIsValid(rpdf);
		return load(readAllBytes(rpdf));
	}
...
//		ef.addCompression();
	 ...
	 */
	@Override
	public OXExporterFromA3 load(RandomAccessRead pdfSource) throws IOException {
	...
	private static byte[] readAllBytes(RandomAccessRead in) throws IOException {
		in.seek(0);
